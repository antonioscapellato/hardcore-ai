resnet20_full_patch_config = {
    ...
    "common_params": {
        ...
        "hash_length": 2048  # Default, suitable for most layers
    },
    ...
    "layer3.0.conv1": {  # Strided conv (32 in, 64 out)
        ...
        "input_tile_size": 256,
        "output_tile_size": 256,
        "hash_length": 4096  # Critical transition layer
    },
    ...
    "layer3.0.downsample.0": {  # Downsample conv (32 in, 64 out)
        ...
        "input_tile_size": 256,
        "output_tile_size": 256,
        "hash_length": 4096  # Critical for downsampling
    },
    ...
    # --- Fully Connected Layer (64 in_features, variable out_features) ---
    "fc": {
        "hash_kernel_type": "learned_projection",
        "input_tile_size": 256,
        "output_tile_size": 256,
        "hash_length": 4096  # Critical for classification, especially for complex datasets
    }
}
