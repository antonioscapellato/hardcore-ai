...
def main():
    ...
    thresholds = {
        32:  10*10.0,  # With shorter hash codes (32 bits), error can be larger
        64:   10*5.0,  # Mid‐range threshold used previously
        128:  10*3.0,  # Longer codes → lower variance
        256:  10*2.0,  # Even longer → tighter bound
    }
